...
export function ProgrammeCard({
  ...
  return (
    <Link
      ...
      className={cn(
        "group relative flex flex-col overflow-hidden rounded-[1.75rem] border border-line bg-canvas-raised transition-all duration-300 hover:-translate-y-1 hover:border-line-strong hover:shadow-[0_28px_60px_-40px_rgba(14,31,25,0.55)]",
        featured && "md:col-span-2 md:flex-row",
      )}
    >
      <div
        className={cn(
          "relative shrink-0 overflow-hidden bg-canvas-sunk",
      ...
      <div className="flex flex-1 flex-col p-7 md:p-8">
        ...
        <h3
          className={cn(
            "mt-3 font-display leading-tight font-semibold text-balance text-ink",
